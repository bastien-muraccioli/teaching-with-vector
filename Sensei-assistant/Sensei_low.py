...
The low version use RetriBert instead Dense Passage Retriever.
It gives better answers but it is slower and needs more memory and better GPU to works with all data sets
...
def init_QAmodel():
    ...
    """
    dataset_dir = "../Dataset/Introduction_to_Robotics"
